           ...
           sm:text-lg sm:leading-7">
                        ...
                        <div class="h-64 flex justify-center items-center">
                            ...
                            <form action="/payment" method="post">
                                @csrf
                                <button type="submit" name="makepayment" class="bg-blue-500 rounded-lg px-4
        ...
        hover:bg-blue-600 focus:outline-none">
                        ...
                        <div class="pt-6 text-xs leading-6  sm:text-sm sm:leading-7">
                            ...
                            <div class="flex items-center text-gray-600 space-x-2">
                                ...
                                <a class="text-gray-600" href="https://www.nasswallet.com"
                                    target="_blank">www.nasswallet.com</a>
                            </div>
                        </div>
                    </div>
                </div>
